...
object nivel_bonus inherits Nivel (siguienteNivel = nivel0 , soyUnNivelGranja=true){
	...
	const listaCajas=[   
						 ...
						 new Caballo(position = game.at(11,6),resolucion=resolucionCaja,stringDeObjeto=caballo1,tipo=4,sonido="caballo1.mp3",ultimaDireccion=abajo),
